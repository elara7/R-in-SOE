...
summary(lm.wage2)
#基准类 单身男性，已婚男性的截距为系数0.2126+截距项0.32
fema<-female*married
...
## chow test
![]("C:\Users\44180\Documents\R-in-SOE\R\R-class\c9\2.PNG")
原假设：没有结构变化
```{r}
...
![]("C:\Users\44180\Documents\R-in-SOE\R\R-class\c9\3.PNG")
...
总共有  
1. 线性-线性模型
2. log-log模型，两边都是对数。系数表示x变化1%，y变化的百分比

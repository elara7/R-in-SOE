...
# ets1<-ets(Y.train,model="ZZZ")  # automatic model(ZZZ I dont know what is the model,using machine learning)
#error type ("A", "M" or "Z");trend type ("N","A","M" or "Z"); season type ("N","A","M" or "Z").  "N"=none, "A"=additive, "M"=multiplicative and "Z"=automatically selected. 
...
time series has autocorrelation,we can devide data into k-flor randomly,only use 1-step ahead        
# 1-step ahead forecasts without re-estimation
```{r}
ets1a<-ets(Y,model=ets1)  # fit entire data with estimated model(using the traning data to fit entire data)
